...
// ვპოულობთ და ვანაცვლებთ მოკლევადიანი ასპექტების მოდალს სრული შიგთავსით
// თუ უკვე არსებობს shortModal, ვანაცვლებთ
const shortModalCode = `
...
// გრძელვადიანი ასპექტების მოდალი
const longModalCode = `
...
// ვცვლით ძველ მოდალურ ფანჯრებს ახლებით (ვპოულობთ მოკლევადიანი და გრძელვადიანი მოდალების ბლოკებს და ვანაცვლებთ)
// მარტივად რომ ვქნათ, წავშალოთ არსებული მოდალები და ბოლოში (return-ის წინ) ჩავსვათ სორტირებულად
// ან უბრალოდ ვპოულობთ <Modal visible={isShortModalVisible}... და ვატარებთ პატარა სკრიპტს

console.log('✅ სკრიპტი მზადაა გასაშვებად');
