...
# 1. დავამატოთ Video იმპორტი თუ არ არის
...
# 2. ვიპოვოთ და შევცვალოთ ჰოროსკოპის ვიდეო ბლოკი ნატივი პლეერით
old_block_start = "<View style={styles.card}>\n            <View style={{ width: '100%', height: 180"
# ალტერნატიული ძებნისთვის მარტივი ნიშნული
if old_block_start not in content:
    old_block_start = "<View style={styles.card}>"

# მოდი მთლიანად ჰოროსკოპის სექცია ჩავანაცვლოთ სუფთა კოდით
...
if start_idx != -1 and end_idx != -1:
    new_horoscope_code = """{activeTab === 'ჰოროსკოპი' ? (
    ...
    content = content[:start_idx] + new_horoscope_code + content[end_idx:]
    with open("App.js", "w", encoding="utf-8") as f:
        f.write(content)
    print("✅ ვიდეო პლეერი წარმატებით ჩაჯდა!")
else:
    print("❌ ვეძებე მაგრამ ზუსტი საზღვრები ვერ ვიპოვე.")
