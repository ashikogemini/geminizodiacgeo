...
export const generateFullNatalReport = (day, month, year, hour, minute, city, unknownTime) => {
  ...
  const signDB = {
    ...
    'თხის რქა': { strength: 'დისციპლინა და ამბიცია.', challenge: 'სიცივე და სიმკაცრე.', advice: 'გამოხატეთ გრძნობები ღიად და დაასვენეთ გონება.', impact: 'სძენს პასუხისმგებლობას, კარიერულ ამბიციასა და გამძლეობას.' },
