...
export const generateFullNatalReport = (day, month, year, hour, minute, city, unknownTime) => {
  ...
  const signDB = {
    'ვერძი': { strength: 'შეუპოვრობა და ლიდერობა.', challenge: 'იმპულსურობა.', advice: 'ისწავლეთ მოთმინება და დაფიქრება მოქმედებამდე.', impact: 'აძლევს ძლიერ დინამიკას, ინიციატივასა და აქტიურ ენერგიას.', meaning: 'აქტიური ენერგია.', daily: 'მოქმედება და ინიციატივა.' },
    'კურო': { strength: 'სტაბილურობა და ერთგულება.', challenge: 'სიჯიუტე.', advice: 'იყავით უფრო ღია ცვლილებებისა და სიახლეების მიმართ.', impact: 'უზრუნველყოფს პრაქტიკულობას, სიმყარესა და მატერიალურ ფოკუსს.', meaning: 'სიმყარე და მატერია.', daily: 'სტაბილურობის შენარჩუნება.' },
    'ტყუპები': { strength: 'ინტელექტი და ადაპტაცია.', challenge: 'ზედაპირულობა.', advice: 'ფოკუსირდით მთავარ მიზანზე და ნუ გაფანტავთ ენერგიას.', impact: 'აძლიერებს კომუნიკაციას, ცნობისმოყვარეობასა და გონებრივ მოქნილობას.', meaning: 'ინტელექტუალური აქტივობა.', daily: 'ინფორმაციის მიღება და გაზიარება.' },
    'კირჩხიბი': { strength: 'ინტუიცია და ემპათია.', challenge: 'წყენის დაგროვება.', advice: 'დააწესეთ ჯანსაღი პირადი საზღვრები.', impact: 'მანათებს ემოციურ სიღრმეს, ოჯახურ ღირებულებებსა და მზრუნველობას.', meaning: 'ემოციური სიღრმე.', daily: 'შინაგანი სამყარო და მზრუნველობა.' },
    'ლომი': { strength: 'ქარიზმა და გულუხვობა.', challenge: 'ეგოცენტრიზმი.', advice: 'მიეცით სხვებსაც საკუთარი თავის გამოხატვის საშუალება.', impact: 'ანიჭებს შემოქმედებით ენერგიას, თვითრწმენასა და ლიდერულ თვისებებს.', meaning: 'შემოქმედებითი ენერგია.', daily: 'თვითგამოხატვა და ლიდერობა.' },
    'ქალწული': { strength: 'ანალიზი და პრაქტიკულობა.', challenge: 'პერფექციონიზმი.', advice: 'ისწავლეთ არასრულყოფილების მიღება და მოდუნება.', impact: 'ზრდის დეტალებისადმი ყურადღებას, დისციპლინასა და ორგანიზებულობას.', meaning: 'ანალიტიკური მიდგომა.', daily: 'დეტალების დამუშავება.' },
    'სასწორი': { strength: 'დიპლომატია და ესთეტიკა.', challenge: 'გადაწყვეტილების სირთულე.', advice: 'ენდეთ საკუთარ არჩევანს და იმოქმედეთ მტკიცედ.', impact: 'მოაქვს ჰარმონია, პარტნიორობის სურვილი და ესთეტიკური ხედვა.', meaning: 'ჰარმონია და ბალანსი.', daily: 'პარტნიორული ურთიერთობები.' },
    'მორიელი': { strength: 'სიღრმე და ნებისყოფა.', challenge: 'ეჭვიანობა.', advice: 'ისწავლეთ ნდობა და ძველი წყენების გაშვება.', impact: 'ამძაფრებს ინტუიციას, შინაგან ძალასა და ტრანსფორმაციის უნარს.', meaning: 'ტრანსფორმაცია.', daily: 'შინაგანი ძიება და სიღრმე.' },
    'მშვილდოსანი': { strength: 'ოპტიმიზმი და ფართო ხედვა.', challenge: 'ტაქტის ნაკლებობა.', advice: 'დააფასეთ დეტალები და იყავით უფრო ყურადღებიანი.', impact: 'მატებს თავგადასავლების სიყვარულს, ოპტიმიზმსა და სულიერ ძიებას.', meaning: 'ფართო ხედვა და ზრდა.', daily: 'ახალი ჰორიზონტები.' },
    'თხის რქა': { strength: 'დისციპლინა და ამბიცია.', challenge: 'სიცივე და სიმკაცრე.', advice: 'გამოხატეთ გრძნობები ღიად და დაასვენეთ გონება.', impact: 'სძენს პასუხისმგებლობას, კარიერულ ამბიციასა და გამძლეობას.', meaning: 'სტრუქტურა და მიზანი.', daily: 'კარიერული წინსვლა.' },
    'მერწყული': { strength: 'ინოვაცია და თავისუფლება.', challenge: 'ემოციური დისტანცია.', advice: 'შეინარჩუნეთ თბილი ემოციური კონტაქტები.', impact: 'აბრუნებს ორიგინალურობას, ჰუმანურობასა და არასტანდარტულ აზროვნებას.', meaning: 'ინოვაციური იდეები.', daily: 'თავისუფლება და მომავალი.' },
    'თევზები': { strength: 'ფანტაზია და სულიერება.', challenge: 'რეალობისგან გაქცევა.', advice: 'შეინარჩუნეთ რეალობის შეგრძნება და მყარად იდექით მიწაზე.', impact: 'ამაღლებს მგრძნობელობას, შთაგონებასა და თანაგრძნობას.', meaning: 'სულიერება და ფანტაზია.', daily: 'ინტუიციური ხედვა.' }
  };
